...
- Numpy:
  ...
  pip install numpy
  ```
- Matplotlib: `Matplotlib` is used to plt the data on graphs.
  ```sh
  pip install matplotlib
  ```
(Remember that type these commands in Command Prompt or Windows Powershell or Terminal.)
- Scikit-learn: `Scikit-learn` is an open source library for using machine learning models. We can use any model from this library.
  ```
  pip install sklearn
  ```
